...
public class CaptchaMapper {
    ...
    public Map<String, RequestBody> mapData(String board, String thread, String message,
                                            String captchaId, String captchaValue) {
        return messagePostResponseToMessage.map(board, thread, message, captchaId, captchaValue);
    }
}
